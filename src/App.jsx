          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="section">
              <div className="section__head">
                <span>Входы</span>
                <button onClick={() => setDraftInputs((prev) => [...prev, { id: nanoid(6), name: '', type: '' }])} disabled={isEditingAutogeneratedType}>+ Вход</button>
              </div>
              {draftInputs.map((p, i) => (
                <div
                ...
                >
                  ...
                  <div className="row-controls">
                    <span className="material-symbols-outlined drag-handle" title="Перетащите для сортировки">drag_indicator</span>
                    <button type="button" className="row-controls__delete" title="Удалить вход" aria-label="Удалить вход" onClick={() => setDraftInputs((prev) => prev.filter((_, idx) => idx !== i))} disabled={isEditingAutogeneratedType}>
            ...
            <div className="section">
              <div className="section__head">
                <span>Выходы</span>
                <button onClick={() => setDraftOutputs((prev) => [...prev, { id: nanoid(6), name: '', type: '' }])} disabled={isEditingAutogeneratedType}>+ Выход</button>
              </div>
              {draftOutputs.map((p, i) => (
                ...
                >
                  ...
                  <div className="row-controls">
                    <span className="material-symbols-outlined drag-handle" title="Перетащите для сортировки">drag_indicator</span>
                    <button type="button" className="row-controls__delete" title="Удалить выход" aria-label="Удалить выход" onClick={() => setDraftOutputs((prev) => prev.filter((_, idx) => idx !== i))} disabled={isEditingAutogeneratedType}>
                      <span className="material-symbols-outlined">delete</span>
                    </button>
                  </div>
                </div>
        ...
        <div className="modal-backdrop" onClick={() => setInstanceEditorOpen(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="section">
              <div className="section__head">
                <span>Входы</span>
                <button onClick={() => setInstanceDraftInputs((prev) => [...prev, { id: nanoid(6), name: '', type: '' }])} disabled={isEditingAutogeneratedInstance}>+ Вход</button>
              </div>
              {instanceDraftInputs.map((p, i) => (
                <div className="row row--with-controls" key={`i-in-${i}`} draggable onDragStart={() => onDragStart('inst-inputs', i)} onDragOver={onDragOver} onDrop={() => onDropRow('inst-inputs', i)} onDragEnd={onDragEnd}>
                  ...
                  <div className="row-controls">
                    <span className="material-symbols-outlined drag-handle" title="Перетащите для сортировки">drag_indicator</span>
                    <button type="button" className="row-controls__delete" title="Удалить вход экземпляра" aria-label="Удалить вход экземпляра" onClick={() => setInstanceDraftInputs((prev) => prev.filter((_, idx) => idx !== i))} disabled={isEditingAutogeneratedInstance}>
                      <span className="material-symbols-outlined">delete</span>
                    </button>
                  </div>
                </div>
            ...
            <div className="section">
              <div className="section__head">
                <span>Выходы</span>
                <button onClick={() => setInstanceDraftOutputs((prev) => [...prev, { id: nanoid(6), name: '', type: '' }])} disabled={isEditingAutogeneratedInstance}>+ Выход</button>
              </div>
              {instanceDraftOutputs.map((p, i) => (
                <div className="row row--with-controls" key={`i-out-${i}`} draggable onDragStart={() => onDragStart('inst-outputs', i)} onDragOver={onDragOver} onDrop={() => onDropRow('inst-outputs', i)} onDragEnd={onDragEnd}>
                  ...
                  <div className="row-controls">
                    <span className="material-symbols-outlined drag-handle" title="Перетащите для сортировки">drag_indicator</span>
                    <button type="button" className="row-controls__delete" title="Удалить выход экземпляра" aria-label="Удалить выход экземпляра" onClick={() => setInstanceDraftOutputs((prev) => prev.filter((_, idx) => idx !== i))} disabled={isEditingAutogeneratedInstance}>
                      <span className="material-symbols-outlined">delete</span>
                    </button>
                  </div>
                </div>
