      ...
      const next = prev.map((n) => {
        ...
        if (!typeDef?.autogeneratedFromFrameId) {
          const normalizedData = {
            ...n.data,
            attributes: ensureDefaultNodeAttributes(n.data.attributes || []),
          };
          if (JSON.stringify(normalizedData) === JSON.stringify(n.data)) return n;
          return { ...n, data: normalizedData };
        }
